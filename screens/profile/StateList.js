...
const StateList = ({
    ...
    return (
        <Overlay
            isVisible={showState}
            onBackdropPress={() => updateParentState({ showState: false })}
        ...
        const renderItem = ({ item }) => {
            return (
                <TouchableOpacity
                    ...
                    onPress={() => {
                        parantUpdateState({ state_id: item.state_id });
                        updateParentState({ showState: false });
        ...
        return (
            <View style={{ ...styles.filterSheetTitleWrapStyle }}>
                ...
                <MaterialIcons
                    ...
                    size={22}
                    color={Colors.blackColor}
                    onPress={() => updateParentState({ showState: false })}
                    style={{
                        padding: 10,
                    }}
                />
