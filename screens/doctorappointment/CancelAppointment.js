        ...
        __getApiData('/api/booking/my_bookings')
            .then((res) => {
                if (res?.response?.response_code === "200" && res?.data?.aaData) {
                    ...
                    const pendingBookings = res?.data?.aaData.filter(item => item.status === '3');
    ...
    const renderHeader = () => {
        return (
            <View style={styles.headerContainer}>
                ...
                />
                <Text style={styles.headerTitle}>My Cancel Appointment</Text>
            </View>
        );
    };
            ...
            <FlatList
                ...
                ListEmptyComponent={
                    <View style={styles.emptyContainer}>
                        <Text style={styles.emptyText}>No cancel appointment available</Text>
                        <TouchableOpacity 
                            style={styles.retryButton} 
                            onPress={fetchBookings}
                        >
